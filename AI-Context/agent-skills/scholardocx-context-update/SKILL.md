---
name: scholardocx-context-update
description: Use when creating, refining, or auditing ScholarDocX AI-Context files and Jira task files. Applies before new features, feature modifications, architecture changes, requirement changes, task completion notes, and context maintenance.
---
