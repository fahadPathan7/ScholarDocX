    ...
    <Modal onClose={onClose} zIndex={1060}>
      <div className="modal-panel max-w-sm" onClick={(e) => e.stopPropagation()}>
        <div className="modal-header flex items-center gap-2">
          ...
          <h3 className="text-base font-semibold text-slate-800">You're out of AI tokens</h3>
        </div>
        <div className="modal-content space-y-2">
          <p className="text-sm text-slate-600">
            Your AI token balance is empty, so this action was blocked. Tokens power AI chat,
            research, Advisor Atlas, and Scholarship Hunt query building.
          </p>
          <p className="text-xs text-slate-500">
            Buy an Extra Token pack to keep going (tokens never expire), or wait for your monthly
            allowance to reset.
          </p>
        </div>
