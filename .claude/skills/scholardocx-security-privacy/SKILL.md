...
description: Use for ScholarDocX secure personal workspace security, privacy, path traversal prevention, file upload/storage safety, SQLite data boundaries, secrets handling, authentication, admin/user roles, and any change that could expose or transmit user data.
---
...
- SQLite and secure files are the default persistence layer.
