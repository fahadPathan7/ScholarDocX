...
const FEATURE_LABELS: Record<string, string> = {
  ...
  can_use_scholarship_hunt: "Scholarship Hunt",
  can_use_scholarship_analyze: "Scholarship opportunity analysis",
  can_use_scholarship_deep_hunt: "Scholarship Deep Hunt",
