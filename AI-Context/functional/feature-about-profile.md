...
Keep user-facing work screens focused on work. Product/system details such as secure personal workspace storage, workspace path, version, and privacy notes belong in Profile or About, not the main dashboard header.

## FR-8: Profile And About

- FR-8.1: The main dashboard should not show "MVP", "secure personal workspace", workspace path, or implementation wording.
- FR-8.2: Profile should show user identity preferences and workspace path/status.
- FR-8.3: About should explain product purpose, privacy/secure storage, AI integrations, and current limitations.
...
column. It should explain ScholarDocX's purpose, secure personal workspace privacy model, AI
