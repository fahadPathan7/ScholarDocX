...
- [x] Polish filter panel typography, option grouping, controls, and action bar
  using ScholarDock's visual system.
...
- ScholarDock seals every selected filter dimension, named scholarship,
...
- Authenticated browser verification used `admin@scholardock.com` with the
