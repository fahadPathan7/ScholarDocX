---
name: scholardock-security-privacy
description: Use for ScholarDock local-first security, privacy, path traversal prevention, file upload/storage safety, SQLite data boundaries, secrets handling, authentication, admin/user roles, and any change that could expose or transmit user data.
---

# ScholarDock Security And Privacy
