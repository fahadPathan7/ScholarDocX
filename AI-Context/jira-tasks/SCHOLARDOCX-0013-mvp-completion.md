...
Build the documented ScholarDocX MVP from the backlog: local workspace initialization, SQLite data model, dashboard, hierarchy, documents, file metadata/uploads, email outreach, reminders, and AI assistant provider boundary.
...
- Project workspace layer added in SCHOLARDOCX-0014.
