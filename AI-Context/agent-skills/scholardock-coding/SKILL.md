---
name: scholardock-coding
description: Use for ScholarDock product code changes in the React/Vite frontend, FastAPI backend, SQLite data layer, local file workspace, services, schemas, and API boundaries. Applies when implementing features, fixing bugs, refactoring source files, or changing runtime behavior.
---
